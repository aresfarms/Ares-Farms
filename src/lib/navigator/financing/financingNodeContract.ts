...
// ── Program registry — MOVED to programCatalog.ts (static citations only;
// rendered surfaces may import the catalog without touching this gated
// contract). Re-exported here so the contract API is unchanged.
export {
  FINANCING_PROGRAMS,
  programsForAsset,

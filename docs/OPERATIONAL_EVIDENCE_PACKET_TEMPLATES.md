...
Template ID: `production-release-board`

Owning role: Production Release Board
...
## Regulator Examination Evidence Archive Packet

Template ID: `regulator-exam-archive`

Owning role: Regulatory Response Owner + Legal/Compliance Reviewer
...
## Production Incident Response Evidence Packet

Template ID: `incident-response`

Owning role: Incident Commander
...
Template ID: `source-promotion`

Owning role: Source Promotion Authority
...
## Live Scraper Activation Evidence Packet

Template ID: `scraper-activation`

Owning role: Source Promotion Authority + Legal/Compliance Reviewer
...
## Revenue Advisory Source Review Packet

Template ID: `revenue-advisory-source-review`

Owning role: Revenue Intelligence Owner + Claims/Compliance Reviewer
...
## Corrective Action Evidence Packet

Template ID: `corrective-action`

Owning role: Corrective Action Owner + Legal/Compliance Reviewer

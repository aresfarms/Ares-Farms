...
const SCANNED_FILES = [
  ...
  "src/lib/property/grantsLaneCurated.ts",
  "src/components/public/GrantsLaneSections.tsx",
  "src/components/public/EnvironmentalOrderPanel.tsx",
  "src/components/public/EnvironmentalFeeChart.tsx",
  "src/lib/property/environmentalFeeSchedule.ts",
  ...
  "src/components/public/LoanProgramComparison.tsx",
  "src/lib/financing/loanProgramComparison.ts",

...
export const stripeConnectAllocations = pgTable("stripe_connect_allocations", {
  ...
  legacyPartnerBasisPoints: integer("stuart_basis_points").notNull().default(0),
  caitlinAmount: integer("caitlin_amount").notNull().default(0),
  legacyPartnerAmount: integer("stuart_amount").notNull().default(0),
  ...
  legacyPartnerConnectedAccountRef: text("stuart_connected_account_ref"),
  caitlinRecipientCertified: boolean("caitlin_recipient_certified").notNull().default(false),
  legacyPartnerRecipientCertified: boolean("stuart_recipient_certified").notNull().default(false),

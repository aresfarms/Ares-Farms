...
/**
 * Ares/Furlong Webportal Home
 *
 * Master Volume Governance:
 * - Vol 0: presents the platform as governed operational coordination infrastructure.
 * - Vol I: preserves constitutional clarity and non-final-decision boundaries.
 * - Vol III: routes users only to stabilized runtime surfaces.
 * - Vol IV: supports operator workflow visibility and controlled module progression.

...
const required = ["verify:cloud-build-release-rule", "verify:official-evidence-source-governance", "verify:official-evidence-refresh-writer", "verify:official-evidence-durable-refresh", "verify:official-evidence-connector-registry", "verify:official-property-source-adapters", "verify:structured-official-evidence", "verify:property-evidence-ingestion", "verify:property-evidence-panel", "verify:property-evidence-manifest", "verify:public-action-evidence", "verify:water-insurance-evidence", "verify:unified-property-risk", "verify:tax-aware-top-three", "verify:post-sale-tax", "verify:property-entry-parity"];

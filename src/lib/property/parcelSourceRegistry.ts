...
export const ARCGIS_PARCEL_SOURCES: ArcgisParcelSource[] = [
  ...
  // ── New Mexico, remaining counties ────────────────────────────────────────
  // The state Office of the State Engineer publishes ALL 33 NM counties as
  // separate layers on ONE service with an identical schema (verified field
  // by field across every layer before these were added). Bernalillo is above;
  // Doña Ana keeps its own county service, which carries assessed values this
  // statewide compilation does not. These entries are boundary + acreage only.
  {
    state: "NM",
    county: "Catron",
    sourceName: "New Mexico OSE — Catron County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/1",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/1/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Chaves",
    sourceName: "New Mexico OSE — Chaves County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/2",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/2/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Cibola",
    sourceName: "New Mexico OSE — Cibola County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/3",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/3/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Colfax",
    sourceName: "New Mexico OSE — Colfax County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/4",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/4/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Curry",
    sourceName: "New Mexico OSE — Curry County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/5",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/5/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "De Baca",
    sourceName: "New Mexico OSE — De Baca County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/6",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/6/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Eddy",
    sourceName: "New Mexico OSE — Eddy County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/8",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/8/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Grant",
    sourceName: "New Mexico OSE — Grant County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/9",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/9/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Guadalupe",
    sourceName: "New Mexico OSE — Guadalupe County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/10",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/10/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Harding",
    sourceName: "New Mexico OSE — Harding County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/11",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/11/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Hidalgo",
    sourceName: "New Mexico OSE — Hidalgo County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/12",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/12/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Lea",
    sourceName: "New Mexico OSE — Lea County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/13",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/13/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Lincoln",
    sourceName: "New Mexico OSE — Lincoln County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/14",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/14/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Los Alamos",
    sourceName: "New Mexico OSE — Los Alamos County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/15",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/15/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Luna",
    sourceName: "New Mexico OSE — Luna County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/16",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/16/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "McKinley",
    sourceName: "New Mexico OSE — McKinley County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/17",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/17/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  // NOT added: Mora County NM. It is on the same OSE service as the other 32
  // and passes a schema check, but its SitusAddressAll column holds ZIP CODES
  // ONLY ("  87722"), never a street address — 7,514 of 7,597 rows. An entry
  // would pass every structural test and then resolve nothing for a real
  // address, while making the state claim statewide coverage it does not have.
  {
    state: "NM",
    county: "Otero",
    sourceName: "New Mexico OSE — Otero County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/19",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/19/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Quay",
    sourceName: "New Mexico OSE — Quay County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/20",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/20/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Rio Arriba",
    sourceName: "New Mexico OSE — Rio Arriba County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/21",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/21/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Roosevelt",
    sourceName: "New Mexico OSE — Roosevelt County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/22",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/22/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Sandoval",
    sourceName: "New Mexico OSE — Sandoval County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/23",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/23/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "San Juan",
    sourceName: "New Mexico OSE — San Juan County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/24",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/24/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "San Miguel",
    sourceName: "New Mexico OSE — San Miguel County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/25",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/25/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Santa Fe",
    sourceName: "New Mexico OSE — Santa Fe County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/26",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/26/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Sierra",
    sourceName: "New Mexico OSE — Sierra County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/27",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/27/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Socorro",
    sourceName: "New Mexico OSE — Socorro County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/28",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/28/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Taos",
    sourceName: "New Mexico OSE — Taos County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/29",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/29/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Torrance",
    sourceName: "New Mexico OSE — Torrance County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/30",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/30/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Union",
    sourceName: "New Mexico OSE — Union County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/31",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/31/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  },
  {
    state: "NM",
    county: "Valencia",
    sourceName: "New Mexico OSE — Valencia County Parcels (boundary + acreage, no values)",
    sourceUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/32",
    queryUrl: "https://gis.ose.nm.gov/server_s/rest/services/Parcels/County_Parcels_2026/MapServer/32/query",
    addressMatchField: "SitusAddressAll",
    cityField: "SitusCity",
    fields: {
      parcelId: "UPC",
  ...
  // ── Arizona, remaining counties on the shared multi-county service ────────
  // Same service and schema as Pima/Coconino/Yuma above (verified per layer).
  // Maricopa is separate — it has its own assessor service WITH values.
  {
    state: "AZ",
    county: "Apache",
    sourceName: "Apache County, Arizona — Parcels (boundary + acreage, no values)",
    sourceUrl: "https://www.arcgis.com/home/item.html?id=c33b63281f80430f89db6f3401154674",
    queryUrl: "https://services.arcgis.com/C34zQ7veRS0V1t04/arcgis/rest/services/Parcels/FeatureServer/0/query",
    addressMatchField: "SITE_ADDRESS",
    cityField: "SITE_CITY",
    fields: {
      parcelId: "APN",
  ...
  },
  {
    state: "AZ",
    county: "Cochise",
    sourceName: "Cochise County, Arizona — Parcels (boundary + acreage, no values)",
    sourceUrl: "https://www.arcgis.com/home/item.html?id=c33b63281f80430f89db6f3401154674",
    queryUrl: "https://services.arcgis.com/C34zQ7veRS0V1t04/arcgis/rest/services/Parcels/FeatureServer/1/query",
    addressMatchField: "SITE_ADDRESS",
    cityField: "SITE_CITY",
    fields: {
      parcelId: "APN",
  ...
  },
  {
    state: "AZ",
    county: "Gila",
    sourceName: "Gila County, Arizona — Parcels (boundary + acreage, no values)",
    sourceUrl: "https://www.arcgis.com/home/item.html?id=c33b63281f80430f89db6f3401154674",
    queryUrl: "https://services.arcgis.com/C34zQ7veRS0V1t04/arcgis/rest/services/Parcels/FeatureServer/3/query",
    addressMatchField: "SITE_ADDRESS",
    cityField: "SITE_CITY",
    fields: {
      parcelId: "APN",
  ...
  },
  {
    state: "AZ",
    county: "Graham",
    sourceName: "Graham County, Arizona — Parcels (boundary + acreage, no values)",
    sourceUrl: "https://www.arcgis.com/home/item.html?id=c33b63281f80430f89db6f3401154674",
    queryUrl: "https://services.arcgis.com/C34zQ7veRS0V1t04/arcgis/rest/services/Parcels/FeatureServer/4/query",
    addressMatchField: "SITE_ADDRESS",
    cityField: "SITE_CITY",
    fields: {
      parcelId: "APN",
  ...
  },
  {
    state: "AZ",
    county: "Greenlee",
    sourceName: "Greenlee County, Arizona — Parcels (boundary + acreage, no values)",
    sourceUrl: "https://www.arcgis.com/home/item.html?id=c33b63281f80430f89db6f3401154674",
    queryUrl: "https://services.arcgis.com/C34zQ7veRS0V1t04/arcgis/rest/services/Parcels/FeatureServer/5/query",
    addressMatchField: "SITE_ADDRESS",
    cityField: "SITE_CITY",
    fields: {
      parcelId: "APN",
  ...
  },
  {
    state: "AZ",
    county: "La Paz",
    sourceName: "La Paz County, Arizona — Parcels (boundary + acreage, no values)",
    sourceUrl: "https://www.arcgis.com/home/item.html?id=c33b63281f80430f89db6f3401154674",
    queryUrl: "https://services.arcgis.com/C34zQ7veRS0V1t04/arcgis/rest/services/Parcels/FeatureServer/6/query",
    addressMatchField: "SITE_ADDRESS",
    cityField: "SITE_CITY",
    fields: {
      parcelId: "APN",
  ...
  },
  {
    state: "AZ",
    county: "Navajo",
    sourceName: "Navajo County, Arizona — Parcels (boundary + acreage, no values)",
    sourceUrl: "https://www.arcgis.com/home/item.html?id=c33b63281f80430f89db6f3401154674",
    queryUrl: "https://services.arcgis.com/C34zQ7veRS0V1t04/arcgis/rest/services/Parcels/FeatureServer/9/query",
    addressMatchField: "SITE_ADDRESS",
    cityField: "SITE_CITY",
    fields: {
      parcelId: "APN",
  ...
  },
  {
    state: "AZ",
    county: "Pinal",
    sourceName: "Pinal County, Arizona — Parcels (boundary + acreage, no values)",
    sourceUrl: "https://www.arcgis.com/home/item.html?id=c33b63281f80430f89db6f3401154674",
    queryUrl: "https://services.arcgis.com/C34zQ7veRS0V1t04/arcgis/rest/services/Parcels/FeatureServer/11/query",
    addressMatchField: "SITE_ADDRESS",
    cityField: "SITE_CITY",
    fields: {
      parcelId: "APN",
  ...
  },
  {
    state: "AZ",
    county: "Santa Cruz",
    sourceName: "Santa Cruz County, Arizona — Parcels (boundary + acreage, no values)",
    sourceUrl: "https://www.arcgis.com/home/item.html?id=c33b63281f80430f89db6f3401154674",
    queryUrl: "https://services.arcgis.com/C34zQ7veRS0V1t04/arcgis/rest/services/Parcels/FeatureServer/12/query",
    addressMatchField: "SITE_ADDRESS",
    cityField: "SITE_CITY",
    fields: {
      parcelId: "APN",
...
const TOTAL_COUNTIES_BY_STATE: Record<string, number> = {
  DE: 3,  // Kent, New Castle, Sussex — all three covered.
  NM: 33, // 32 of 33 covered; Mora publishes zip codes, not addresses (see above).
...
export function parcelCoverageForState(stateCode: string): ParcelCoverage {
  ...
  // Enumerating every area stops being useful past a handful — a sentence
  // naming 13 counties is not something a person reads. Summarise instead,
  // and give the fraction when the state's county count is known.
  const total = TOTAL_COUNTIES_BY_STATE[st];
  const list = areas.length === 1
    ? areas[0]
    : areas.length <= 5
      ? `${areas.slice(0, -1).join(", ")} and ${areas[areas.length - 1]}`
      : total
        ? `${areas.length} of ${st}'s ${total} counties`

...
const s = await m.recordAttestation({ testerEmail: "stuart@aresfarmsinc.com", verdict: "PASS_WITH_FINDINGS", findings: [{ category: "USABILITY", severity: "LOW", summary: "Navigation label should be clearer." }] });

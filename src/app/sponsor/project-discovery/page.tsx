...
export default function SponsorProjectDiscoveryPage() {
      ...
      <section style={containerStyle}>
        <header>
          ...
          <p style={{ maxWidth: 760, color: "#4d5a6c" }}>
            Project discovery organizes advisory marketplace signals for
            sponsor coordination while institutional validation remains pending.
          </p>
        </header>

        <section style={panelStyle}>
          <h2 style={{ marginTop: 0, fontSize: 20 }}>Workflow Status</h2>
        ...
        <section style={panelStyle}>
          <h2 style={{ marginTop: 0, fontSize: 20 }}>Discovery Inputs</h2>

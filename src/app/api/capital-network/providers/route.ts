...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const provider = await createProviderApplication({
      ...
      publishedCreditBox: body.publishedCreditBox && typeof body.publishedCreditBox === "object" && !Array.isArray(body.publishedCreditBox) ? body.publishedCreditBox : {},
      collateralPolicy: body.collateralPolicy && typeof body.collateralPolicy === "object" && !Array.isArray(body.collateralPolicy) ? body.collateralPolicy : {},
      environmentalRequirements: body.environmentalRequirements && typeof body.environmentalRequirements === "object" && !Array.isArray(body.environmentalRequirements) ? body.environmentalRequirements : {},
      typicalFirstResponseDays: typeof body.typicalFirstResponseDays === "number" ? body.typicalFirstResponseDays : null,
      typicalClosingDays: typeof body.typicalClosingDays === "number" ? body.typicalClosingDays : null,
      creditBoxSourceRefs: Array.isArray(body.creditBoxSourceRefs) ? body.creditBoxSourceRefs : [],

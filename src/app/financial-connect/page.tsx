...
export default async function FinancialConnectPage({ searchParams }: { searchParams: Promise<{ dealRef?: string }> }) {
  ...
  const assurance = secret ? await verifyMfaAssurance({
  ...
  return <FinancialConnectClient dealRef={dealRef} />;
}

...
export const canonicalDomainRegistry: readonly CanonicalDomainDefinition[] = [
  {
    ...
    authorityModule: "src/lib/canonical-properties/index.ts",
    authorityExport: "canonicalProperty",
  ...
  },
  {
    key: "place",
    displayName: "Place",
    authorityModule: "src/lib/place-facts/placeFactActivation.ts",
    authorityExport: "PLACE_FACT_ACTIVATIONS",
  ...
  },
  {
    ...
    authorityModule: "src/lib/property/auditLedger.ts",
    authorityExport: "appendAuditEvent",
  ...
  },
  {
    ...
    authorityModule: "src/lib/evidence/documentEvidenceReconciliationRuntime.ts",
    authorityExport: "composeDocumentEvidenceReconciliation",
  ...
  },
  {
    key: "source",
    displayName: "Source",
    authorityModule: "src/lib/source-stack/sourceStackRuntime.ts",
    authorityExport: "CANONICAL_ENTITY_PROFILES",
  ...
  },
  {
    key: "program",
    displayName: "Program",
    authorityModule: "src/lib/program-graph/index.ts",
    authorityExport: "PROGRAM_GRAPH",
  ...
  },
  {
    ...
    authorityModule: "src/lib/providers/providerRegistry.ts",
    authorityExport: "PROVIDERS",
  ...
  },
  {
    key: "report",
    displayName: "Report",
    authorityModule: "src/lib/reports/reportRecordStore.ts",
    authorityExport: "persistReportRecord",
  ...
  },
  {
    ...
    authorityModule: "src/lib/opportunity/discoveryV2Runtime.ts",
    authorityExport: "composeOpportunityDiscoveryV2",

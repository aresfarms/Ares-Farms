...
assert(actorMayDecide("sfraas@aresfarmsinc.com","STUART_NAMED_TESTER"),"Stuart binding missing.");
...
assert(!actorMayUseStagingUltimateAuthority("sfraas@aresfarmsinc.com", stagingOverrideEnv),"Unlisted identities must not receive staging ultimate authority.");
